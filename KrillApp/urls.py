...
urlpatterns = [
                  ...
                  path("images_successful/", TemplateView.as_view(
                      template_name='images_successful.html'), name='images_successful'),
                  ...
                  path("get_trip_image_list/", views.Get_Trip_Image_List,
                       name='get_trip_image_list'),
                  path("upload_image_to_trip/", views.Upload_Image_To_Trip,
                       name='upload_image_to_trip'),
                  ...
                  path("save_image_annotations/", ImageAnnotationsAPIView.as_view(),
                       name='save_image_annotations'),
                  path("load_image_annotations/", views.Load_Image_Annotations,
                       name='load_image_annotations'),
