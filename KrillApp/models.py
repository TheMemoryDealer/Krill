...
class Krill(models.Model):
    ...
    position = models.TextField(default="")
    altr_view = models.TextField(default="")
    altr_x = models.CharField(max_length=50, default="")
    altr_y = models.CharField(max_length=50, default="")
    altr_height = models.CharField(max_length=50, default="")
    altr_width = models.CharField(max_length=50, default="")